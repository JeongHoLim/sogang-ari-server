...
public class ManagerController {
    ...
    @PostMapping("/{club_id}/{manager_id}/join/{user_id}")
    @ApiOperation(value = "동아리 가입 승인",notes="특정 유저 동아리 가입 승인")
    public ResponseEntity<?> postJoinedClub(@PathVariable(name = "user_id") String userId,
                                            @PathVariable(name = "manager_id") String managerId,
                                            @PathVariable(name = "club_id") Long clubId) {
        return managerService.postJoinedClub(clubId,managerId,userId);
    }
    ...
    @PostMapping("{club_id}/{manager_id}/delegate/{user_id}")
    ...
    public ResponseEntity<?> delegateClub(@PathVariable(name = "manager_id") String managerId,
                                          ...
                                          @PathVariable(name = "club_id") Long clubId){
        return managerService.delegateClub(clubId,managerId,userId);
    }
